...
function ResumeBuilder() {
  const { token, currentUser, loading, getJson, putJson, updateUser } =
    useAuth();
  ...
  const saveProfile = async () => {
    ...
    setStatusMessage(
      "Resume profile saved. You can now use it for guidance and interview prep.",
    );
  };
        ...
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <div className="border border-gray-200 rounded-lg p-6 shadow-sm">
            <p className="text-gray-700 mb-4">
              Log in to build and save your resume profile.
            </p>
            <Link
              to="/login"
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">
            Save your core resume content so CareerX-AI can personalize
            guidance.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
          ...
          <div className="mt-5 flex items-center gap-4">
            ...
            {statusMessage && (
              <span
                className={`text-sm ${statusMessage.startsWith("Resume") ? "text-green-700" : "text-red-700"}`}
              >
                {statusMessage}
              </span>
            )}

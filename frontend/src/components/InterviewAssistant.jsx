    ...
    return (
      <div className="min-h-screen bg-white py-16">
        <div className="container mx-auto px-4 max-w-2xl">
          <h3 className="text-3xl font-bold text-gray-900 mb-3">Interview Assistant</h3>
          <div className="border border-gray-200 rounded-lg p-6 shadow-sm">
            <p className="text-gray-700 mb-4">Log in to generate practice questions and get feedback on your answers.</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="mb-6">
          <h3 className="text-3xl font-bold text-gray-900">Interview Assistant</h3>
          <p className="text-gray-600 mt-2">Generate role-specific questions and get feedback on your practice answers.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-[360px_1fr] gap-6">
          <section className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm h-fit">
            ...
            {focusAreas.length > 0 && (
              <div className="mt-5">
                <h5 className="text-sm font-semibold text-gray-900 mb-2">Focus Areas</h5>
                <div className="flex flex-wrap gap-2">
                  {focusAreas.map((area) => (
                    <span key={area} className="text-xs rounded-full bg-green-50 text-green-800 border border-green-200 px-3 py-1">
                      {area}
                    </span>
                  ))}
                </div>
          ...
          <section className="space-y-6">
            <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
              ...
              {questions.length === 0 ? (
                <p className="text-gray-600">Generate questions to begin a practice round.</p>
              ) : (
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
                ...
                {feedback.improvedAnswer && (
                  <div className="mt-5 rounded-md bg-gray-50 border border-gray-200 p-4">
                    <h5 className="font-semibold text-gray-900 mb-2">Improved Direction</h5>
                    <p className="text-gray-700 whitespace-pre-wrap">{feedback.improvedAnswer}</p>
                  </div>
                )}
              </div>
            )}

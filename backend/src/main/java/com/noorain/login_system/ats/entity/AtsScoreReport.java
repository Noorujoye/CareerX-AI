...
@Entity
@Table(name = "ats_score_reports", indexes = {
        @Index(name = "idx_ats_score_reports_user_created", columnList = "user_id,created_at"),
        @Index(name = "idx_ats_score_reports_created", columnList = "created_at")
})
@Getter
@Setter
@Builder
